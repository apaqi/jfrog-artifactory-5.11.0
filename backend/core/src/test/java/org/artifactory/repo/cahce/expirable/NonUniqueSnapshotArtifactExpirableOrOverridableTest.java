...
public class NonUniqueSnapshotArtifactExpirableOrOverridableTest {
    ...
    private NonUniqueSnapshotArtifactExpirableOrOverridable expirable = new NonUniqueSnapshotArtifactExpirableOrOverridable();
    ...
    private LocalCacheRepo getLocalCacheRepoMock(String artifactPath) throws NoSuchFieldException, IllegalAccessException {
        ...
        Field repoServiceField = expirable.getClass().getDeclaredField("repositoryService");
        repoServiceField.setAccessible(true);
        repoService = EasyMock.createMock(InternalRepositoryService.class);
        repoServiceField.set(expirable, repoService);
