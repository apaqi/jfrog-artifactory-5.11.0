...
public class HttpRepo extends RemoteRepoBase<HttpRepoDescriptor> {
    ...
    public void init() {
        ...
        if (!isOffline()) {
            this.client = createHttpClient(ConstantValues.httpClientMaxTotalConnections.getInt());
        }
    }
    ...
    protected CloseableHttpResponse doExecuteMethod(HttpRequestBase method, @Nullable HttpContext context,
            Map<String, String> extraHeaders, CloseableHttpClient client) throws IOException {
    ...
    protected final CloseableHttpClient createHttpClient(int maxTotalConnections) {
