        ...
        switch (model.getRepoType()) {
            ...
            case Pypi:
                ...
                pypi.setListRemoteFolderItems(Optional.ofNullable(pypi.isListRemoteFolderItems())
                        .orElse(DEFAULT_LIST_REMOTE_ITEMS_SUPPORTED_TYPE));
                pypi.setRegistryUrl(Optional.ofNullable(pypi.getRegistryUrl()).orElse(DEFAULT_PYPI_REGISTRY));
                break;
            case GitLfs:
                ...
                break;
            case Go:
                GoTypeSpecificConfigModel go = (GoTypeSpecificConfigModel) model;
                validateVcsConfig(go);
                break;
            case Composer:
