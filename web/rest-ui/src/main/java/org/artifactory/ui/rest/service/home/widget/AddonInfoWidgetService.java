...
public class AddonInfoWidgetService implements RestService {
    ...
    private void updateAddonList(HashMap<String, AddonInfo> addonInfoMap, List<AddonModel> addonModels) {
        ...
        AddonState ossDefaultState = isConanCE() ? AddonState.NOT_LICENSED : AddonState.ACTIVATED;
        ...
        addonModels.add(new AddonModel(AddonType.GO, addonInfoMap.get("go"), getAddonLearnMoreUrl("go"), getAddonConfigureUrl(AddonType.GO.getConfigureUrlSuffix())));
        ...
        addonModels.add(new AddonModel(AddonType.MAVEN_PLUGIN, getAddonInfo(AddonType.MAVEN_PLUGIN, ossDefaultState), getAddonLearnMoreUrl("maven"), getAddonConfigureUrl(AddonType.MAVEN_PLUGIN.getConfigureUrlSuffix())));
        addonModels.add(new AddonModel(AddonType.GRADLE_PLUGIN, getAddonInfo(AddonType.GRADLE_PLUGIN, ossDefaultState), getAddonLearnMoreUrl("gradle"), getAddonConfigureUrl(AddonType.GRADLE_PLUGIN.getConfigureUrlSuffix())));
        ...
        addonModels.add(new AddonModel(AddonType.SBT, getAddonInfo(AddonType.SBT, ossDefaultState), getAddonLearnMoreUrl("sbt"), getAddonConfigureUrl(AddonType.SBT.getConfigureUrlSuffix())));
        addonModels.add(new AddonModel(AddonType.IVY, getAddonInfo(AddonType.IVY, ossDefaultState), getAddonLearnMoreUrl("ivy"), getAddonConfigureUrl(AddonType.IVY.getConfigureUrlSuffix())));
    ...
    private boolean isConanCE() {
        return ContextHelper.get().beanForType(AddonsManager.class).getArtifactoryRunningMode() ==  ArtifactoryRunningMode.CONAN;
    }
}
