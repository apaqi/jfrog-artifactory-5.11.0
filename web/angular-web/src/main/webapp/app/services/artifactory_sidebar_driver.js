export class ArtifactorySidebarDriver {
    constructor($timeout, $rootScope, $state, User, FooterDao, ArtifactoryFeatures, JFrogEventBus,
                ArtifactoryStorage, ArtifactoryState) {
    ...
    getMenuItems() {
        return [
            ...
            },
            {
                ...
                selected: false,
                isDisabled: !this.ArtifactoryFeatures.isEnterprisePlus() && !this.ArtifactoryFeatures.isEdgeNode(),
                isHidden: !this.ArtifactoryFeatures.isEnterprisePlus() && !this.ArtifactoryFeatures.isEdgeNode()
            },
            {
                label: 'Builds',
                stateParent: "builds",
                ...
                isHidden: this.ArtifactoryFeatures.isHidden('builds')
            },
            {
                label: 'Admin',
        ...
        let adminItems = [
...

            {
                ...
                "subItems": [
                    ...
                    //{"label": "Trusted Keys", "state": "admin.security.trusted_keys", "feature": "trustedkeys"}, // TODO: Add with ENT+ release
        ...
        this.footerDao.get(false).then(footerData => {
            ...
            adminItems.forEach((item) => {
                ...
                item.subItems.forEach((subitem) => {
                    ...
                    if (this.features.isEdgeNode() && subitem.label === 'Remote') {
                        subitem.isHidden = true;
                        return;
                    }
                    if (this.features.isConanCE() && subitem.label === 'Maven Indexer') {
                        subitem.isHidden = true;
                        return;
                    }
