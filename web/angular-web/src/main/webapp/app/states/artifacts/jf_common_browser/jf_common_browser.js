...
export default class JFCommonBrowser {
    constructor(JFTreeApi, $scope, ArtifactActions, ArtifactoryState) {
        ...
        this.packageTypesReplacingArchives = ['bower','npm','cocoapods','gitlfs','opkg','composer','pypi','vagrant', 'helm', 'chef', 'go'];
    }
