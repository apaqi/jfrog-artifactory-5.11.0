let snippets = {
    ...
    go: {
        general: [{
            before: `To work with Go repositories, first install and configure your vgo client. 
        ...
        read: [
            {
                before: `There are two ways to resolve a Go package from Artifactory: using JFrog CLI or using the vgo client. <br>
            ...
            {
                before: `<h2>Using vgo</h2>To resolve a Go package from this repository using vgo, first set your default Artifactory Go repository/registry by running the following command:`,
