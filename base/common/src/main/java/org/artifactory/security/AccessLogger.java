...
public abstract class AccessLogger {
    ...
    public static void disapproved(boolean denied, Authentication authentication, String message) {
        logAction(null, Action.DISAPPROVE, denied, authentication, message);
    }
