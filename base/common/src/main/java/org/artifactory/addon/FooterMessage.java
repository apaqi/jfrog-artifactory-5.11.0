...
public class FooterMessage {
    ...
    public FooterMessage(String message, FooterMessageType type,FooterMessageVisibility visibility, boolean dismissCode) {
        this.message = message;
        this.type = type.name();
        this.visibility=visibility.name();
