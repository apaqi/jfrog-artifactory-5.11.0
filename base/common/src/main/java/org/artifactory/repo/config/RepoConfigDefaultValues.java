...
public abstract class RepoConfigDefaultValues {
    ...
    public static final List<String> DEFAULT_GO_METADATA_URLS =
            ImmutableList.of("**/" + GoGitProvider.Github.prefix, "**/" + GoGitProvider.GoGoogleSource.prefix, "**/" + GoGitProvider.Gopkgin.prefix);
    ...
    public static final String PYPI_URL = "https://files.pythonhosted.org";
