...
import org.artifactory.logging.version.v10.LogbackRemoveZipLogsConverter;
...
public enum LoggingVersion implements SubConfigElementVersion {
    ...
    v9(ArtifactoryVersion.v550m001, ArtifactoryVersion.v582, new LogbackAddMigrationLogsConverter()),
    v10(ArtifactoryVersion.v583, ArtifactoryVersion.getCurrent(),
            new LogbackAddEventLogConverter(), new LogbackRemoveZipLogsConverter());
