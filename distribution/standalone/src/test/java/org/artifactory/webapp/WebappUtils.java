...
public abstract class WebappUtils {
    ...
    public static File getDevEtcFolder() {
        String[] folderNames = new String[]{
                "artifactory-oss/distribution/standalone/src/test/resources/dev/etc",
                "distribution/standalone/src/test/resources/dev/etc"
        };
    ...
    public static File getAccessStandaloneJar() {
        String[] folderNames = new String[] {
                "jfrog-access/server/application/target/access-application-3.3.x-SNAPSHOT-standalone.jar",
