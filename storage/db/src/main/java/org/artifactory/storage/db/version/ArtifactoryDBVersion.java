...
public enum ArtifactoryDBVersion implements SubConfigElementVersion {
    ...
    v206(ArtifactoryVersion.v580, ArtifactoryVersion.v586, new DBSqlConverter("v580")),
    v207(ArtifactoryVersion.v590m001, ArtifactoryVersion.v592, new DBSqlConverter("v207_bundles"),
            new DBSqlConverter("v207_events")),
    v208(ArtifactoryVersion.v5100m009, ArtifactoryVersion.getCurrent(), new DBSqlConverter("v208_blob_infos"));
